...
def performance(x, y, ens, metric='AUC', savename=None):
    ...
    Plot the true vs. the inferred performance of each base classifier.
    Along the y-axis plot the performance of each inputted ensemble.
    ...
    plt.plot(x, y, 'o', mfc='none', mew=2, ms=7.5, 
            label='Base Classifiers')
